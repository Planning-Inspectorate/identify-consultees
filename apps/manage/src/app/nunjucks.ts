...
export function configureNunjucks(): nunjucks.Environment {
	...
	// get the path to the @pins/identify-consultees-lib folder, in node_modules, using the node require resolution
	const libUi = path.resolve(require.resolve('@pins/identify-consultees-lib'), '..');
